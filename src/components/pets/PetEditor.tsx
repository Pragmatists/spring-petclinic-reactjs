...
import {IEditablePet, IError, IOwner, IPetRequest, IPetType, IRouterContext, ISelectOption} from '../../types';
...
export default class PetEditor extends React.Component<IPetEditorProps, IPetEditorState> {
    ...
    onSubmit(event) {
        ...
        const typeId = (typeof editablePet.typeId === 'string' ? parseInt(editablePet.typeId) : editablePet.typeId) as number;
        const selectedPetType = pettypes.find(type => type.value === typeId) as ISelectOption;
